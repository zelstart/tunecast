...
$(document).ready(function () {
  ...
  $('#getWeatherBtn').click(async function () {
    ...
    if (city === '') {
      ...
      if (state) {
        // Get weather data for city and state
        const weatherData = await getWeatherByCityAndState(city, state);
        ...
        // Get weather data for city only
        const weatherData = await getWeatherByCityAndState(city);
